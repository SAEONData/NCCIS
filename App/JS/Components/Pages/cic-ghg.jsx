          ...
          <div className="container-fluid">
            <div className="row">
              ...
              <div className="row">
                ...
                <p>This has led the Intergovernmental Panel on Climate Change (IPCC) to conclude recently that most of the warming of the last 50 years is attributable to human activities.</p>
                </div>
                <div className="col-6">
                <img src={dtree} />
                </div>
