      ...
      <>
       <section class="ea-content-full">
          ...
          <div className="container-fluid">
            ...
            <div className="col-6">
              <p>South Africa's 3rd National Communication to the UNFCCC, provides an updated analysis of trends in temperature, rainfall and extreme events. Extreme indices developed by the World Meteorological Organization (WMO) Expert Team on Climate Change Detection and Indices (ETCCDI) were utilised. The analysis builds on the studies of Kruger & Sekele (2012) and Mackellar et al. (2014).</p>
