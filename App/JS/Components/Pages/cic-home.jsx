       ...
       <section class="ea-content-full">
          ...
          <div className="container-fluid">
            <div className="row">
              ...
              <p><b onClick={() => { location.hash = "/info-glossary/#bm-cv" }} class="text-link">Climate variability</b> refers to variations in climate on all spatial and temporal scales beyond that of individual weather events. This variability may be caused by natural internal processes within the climate system. One of the most important (and widely known) examples of natural climate variability is the <span onClick={() => { location.hash = "/info-glossary/#bm-enso" }} class="text-link">El Niño-Southern Oscillation (ENSO)</span>. Variations may also be caused by external influences which may be due to naturally-occurring phenomena (such as periodic changes in the earth’s orbit around the sun).</p>
