          ...
          <div className="container-fluid">
            <div className="row">
              ...
              <p>Anthropogenic emissions of greenhouse gases (the main cause of anthropogenic climate change) have increased steadily since the industrial revolution.</p>
                ...
                <p>This has led the Intergovernmental Panel on Climate Change (<span onClick={(event) => {event.preventDefault(); window.open("#/info-glossary/#bm-ipcc");}} className="text-link">IPCC</span>) to conclude recently that most of the warming of the last 50 years is attributable to human activities.</p>
                <img src={dtree} />
              </div>
              <div className="col-6 pt-4 mt-3">
              <p className="mt-4"><b onClick={(event) => {event.preventDefault(); window.open("#/info-glossary/#bm-cc");}} className="text-link">Climate change</b> refers to a change in the average weather experienced in a particular region or location. The change may occur over periods ranging from decades to millennia. It may affect one or more seasons (e.g. summer, winter or the whole year) and involves changes in one or more aspects of the weather e.g. rainfall, temperature or winds. Its causes may be natural (e.g. due to periodic changes in the earth’s orbit, volcanoes and solar variability) or attributable to human (anthropogenic) activities e.g. increasing emissions of greenhouse gases such as CO2, land use change and/or emissions of aerosols. ‘Climate change’ often refers to changes due only to anthropogenic causes.</p>
              <p><b onClick={(event) => {event.preventDefault(); window.open("#/info-glossary/#bm-gw");}} className="text-link">Global warming</b> refers only to the overall warming of the Earth, based on average increases in temperature over the entire land and ocean surface. Climate change is more than simply an increase in global temperatures; it encompasses changes in regional climate characteristics, including temperature, humidity, rainfall, wind, and extreme weather events, which have economic and social dimensions.</p>
              <p><b onClick={(event) => {event.preventDefault(); window.open("#/info-glossary/#bm-cv");}} className="text-link">Climate variability</b> refers to variations in climate on all spatial and temporal scales beyond that of individual weather events. This variability may be caused by natural internal processes within the climate system. One of the most important (and widely known) examples of natural climate variability is the <span onClick={(event) => {event.preventDefault(); window.open("#/info-glossary/#bm-enso");}} className="text-link">El Niño-Southern Oscillation (ENSO)</span>. Variations may also be caused by external influences which may be due to naturally-occurring phenomena (such as periodic changes in the earth’s orbit around the sun).</p>
              </div>
            </div>
