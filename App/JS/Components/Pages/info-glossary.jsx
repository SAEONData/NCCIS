    ...
    return (
      <>
       <section class="ea-content-full">
          ...
          <p><b id="bm-gw">Global warming</b> refers only to the overall warming of the Earth, based on average increases in temperature over the entire land and ocean surface. Climate change is more than simply an increase in global temperatures; it encompasses changes in regional climate characteristics, including temperature, humidity, rainfall, wind, and extreme weather events, which have economic and social dimensions. </p>
          ...
          <p><b id="bm-ipcc">IPCC</b>The Intergovernmental Panel on Climate Change (IPCC) is the United Nations body for assessing the science related to climate change.</p>
          ...
          <p>The <b id="bm-enso">El Niño-Southern Oscillation</b> (ENSO) is a recurring natural climate phenomenon that is caused by abnormal warming in sea surface temperatures across the Equatorial Pacific is usually associated with high temperatures and below normal rainfall in the southern hemisphere. </p>
