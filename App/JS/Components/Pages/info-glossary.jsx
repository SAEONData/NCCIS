    ...
    return (
      <>
       <section class="ea-content-full">
          ...
          <p>The <b>El Niño-Southern Oscillation</b> (ENSO) is a recurring natural climate phenomenon that is caused by abnormal warming in sea surface temperatures across the Equatorial Pacific is usually associated with high temperatures and below normal rainfall in the southern hemisphere. </p>
